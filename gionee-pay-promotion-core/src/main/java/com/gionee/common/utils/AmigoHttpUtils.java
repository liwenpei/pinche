...
public class AmigoHttpUtils {
	...
	public static  StringBuilder joinKeyAndValue(SortedMap<String, Object> packageParams)
			throws UnsupportedEncodingException {
		StringBuilder content = new StringBuilder(1024);
		Set<Entry<String, Object>> paramSet = packageParams.entrySet();
		Iterator<Entry<String, Object>> iterator = paramSet.iterator();
		while (iterator.hasNext()) {
			Map.Entry entry = iterator.next();
			String k = (String) entry.getKey();
			content.append("<" + k + ">" + entry.getValue() + "</" + k + ">");
		}
		return content;
	}
