...
public class AndroidPost {
	...
	public static void main(String[] args) throws IOException {
		...
		**/
		...
		String url = "http://192.168.27.12:8080/RegisterSystem/Upload_html";
	...
	public static Map<String, String> sendParam() {
		...
		String key1 = "param";
		String value1 = "content中文dfsdfsdfs";
	...
	public static String doPost(String urlString, Map<String, String> nameValuePairs)
		...
		try (PrintWriter out = new PrintWriter(connection.getOutputStream())) {
			...
			//out.print(URLEncoder.encode("圣诞节分类是京东方讲的是eee2", "UTF-8"));
			out.write(URLEncoder.encode("圣诞节分类是京东方讲的是eee5", "UTF-8"));
			out.flush();
			connection.getResponseCode();//.getInputStream();
