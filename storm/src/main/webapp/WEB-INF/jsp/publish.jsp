		...
		<div class="page-header-inner">
			...
			<div class="hor-menu hor-menu-light hidden-sm hidden-xs">
				<ul class="nav navbar-nav">
					...
					<li class="classic-menu-dropdown "><a href="publish_query.do">班次管理
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				<h3 class="page-title">班次管理</h3>
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">班次管理</div>
								<div class="actions">
									<div class="btn-group">
									...
									<form role="form" method="post" id="queryForm"
										...
										<div class="form-body">
											<div class="form-group col-md-3">
												<label class="col-md-3 control-label">ID号:</label>
												<div class="col-md-7">
													<input type="text" class="form-control" placeholder="publish_id"
														name="publish_id" id="publish_id" value="">
												</div>
											</div>
									...
									<tbody>
										<c:forEach items="${list}" var="mg">
											<tr>
												...
												<td align="center">${mg.fromArea}</td>
												<td align="center">${mg.toArea}</td>
												<td align="center"><fmt:formatDate
														value="${mg.startTime}" pattern="yyyy-MM-dd hh:mm:ss" /></td>
												<td align="center"><fmt:formatDate
														value="${mg.endTime}" pattern="yyyy-MM-dd hh:mm:ss" /></td>
												<td align="center"><a href="javascript:void:(0);"
													class="btn  blue"
													onclick="view('${mg.id}')">详情</a>
...
<![endif]-->
	...
	<script src="js/publish/publish.js" type="text/javascript"></script>
